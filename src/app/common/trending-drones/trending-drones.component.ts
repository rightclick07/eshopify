...
@Component({
  selector: 'app-trending-drones',
  templateUrl: './trending-drones.component.html',
  styleUrls: ['./trending-drones.component.css']
})
export class TrendingDronesComponent implements OnInit, AfterViewInit {
